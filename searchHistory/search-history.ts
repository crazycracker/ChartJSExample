import { ExperienceFormData, RecruiterFormData } from './../user-profile/userProfile';
...
export interface ISearchHistoryFormData {
    ...
    diversity: string;
    educational_details: Array<RecruiterFormData>;
    experience_details: Array<ExperienceFormData>;
...
export class SearchHistoryFormData implements ISearchHistoryFormData {
    constructor(
        ...
        public educational_details: Array<RecruiterFormData>,
        public experience_details: Array<ExperienceFormData>,
        public languages_known: Array<string>
    ) { }
}
